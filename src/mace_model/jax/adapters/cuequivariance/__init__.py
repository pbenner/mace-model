...
class Linear:
    """Returns the local cue-backed linear adapter."""
...
class TensorProduct:
    """Wrapper around the local cue tensor product."""
...
def FullyConnectedTensorProduct(
    ...
    """Wrapper around the local cue-backed fully connected tensor product."""
    use_cue = (
